...
set(bars(1),'FaceColor','y'); set(bars(1),'EdgeColor','k');
set(bars(2),'FaceColor','b'); set(bars(2),'EdgeColor','k');
...
bar(x,[nL nM],'stacked');
bars = get(gca,'Children');
set(bars(1),'FaceColor','g'); set(bars(1),'EdgeColor','k');
set(bars(2),'FaceColor','r'); set(bars(2),'EdgeColor','k');
