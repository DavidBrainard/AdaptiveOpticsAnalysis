...
for f=1 : size(stack_fname,1)
    ...
    default_dmb_contents.n_columns_desinusoided= size(vertical_fringes_desinusoid_matrix,1);
    default_dmb_contents.n_columns_raw_sequence= size(vertical_fringes_desinusoid_matrix,2);
