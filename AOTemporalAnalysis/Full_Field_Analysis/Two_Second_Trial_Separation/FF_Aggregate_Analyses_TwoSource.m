...
%   "FF_aggregate_Multi_Trial_Run_Twosource.m"), but if the software is run by
%   itself it will prompt the user for the folders containing the
%   pre-analyzed mat files generated by FF_Temporal_Reflectivity_Analysis.m.
%
% Inputs:
...
%
% Created by Robert F Cooper 6-20-2017
%
...
% Subtract the control and standard deviation signals.
