function [ file_list isdir numfiles ] = read_folder_contents( root_dir,extension, wild_card )
...
if ~exist('extension','var')
    file_list=dir(fullfile(root_dir, wild_card) );
    file_list=file_list(3:end);
else
    file_list=dir(fullfile(root_dir,[wild_card extension]));
end
