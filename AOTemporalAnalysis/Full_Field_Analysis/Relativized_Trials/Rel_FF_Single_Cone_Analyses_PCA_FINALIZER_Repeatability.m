...
timeFromStim = (0:size(stddev_stim_450nW1,2)-1)/16.66666;
...
for i=1:size(allcoords,1)
    if large_n_valid(i) 
        ...
        for num_coeffs=0:3
            ...
            legend('Raw signal','1 Coefficient','2 Coefficients','3 Coefficients','Location','northwest');
            xlabel('Time from stimulus onset (s)'); ylabel('Std dev Response');
            title(['450nW Subbed (Projected value: ' num2str(Stddev_450nW1(i)) ')']); axis([0 max(timeFromStim) -1 7]);
            hold off;
            ...
            legend('Raw signal','1 Coefficient','2 Coefficients','3 Coefficients','Location','northwest');
            xlabel('Time from stimulus onset (s)'); ylabel('Std dev Response');
            title(['50nW Subbed (Projected value: ' num2str(Stddev_450nW2(i)) ')']); axis([0 max(timeFromStim) -1 5]);        
            hold off;
...
for i=1:size(allcoords,1)
    if large_n_valid(i)  
        ...
        for num_coeffs=0:3
            ...
            legend('Raw signal','1 Coefficient','2 Coefficients','3 Coefficients','Location','northwest');
            xlabel('Time from stimulus onset (s)'); ylabel('Median Response');
            title(['450nW Subtracted (Projected value: ' num2str(abs(Median_450nW1(i))) ')']); axis([0 max(timeFromStim) -5 5]);
            hold off;
...
% axis square; axis([-2 10 0 5]); grid on; title('0nW'); ylabel('Absolute median response'); xlabel('Std dev response');
errorbar(median(Stddev_450nW2(valid)),median(abs(Median_450nW2(valid))), median(abs(Median_450nW2(valid)))-quantile(abs(Median_450nW2),0.05),quantile(abs(Median_450nW2),0.95)-median(abs(Median_450nW2(valid))),...
                                                                     median(Stddev_450nW2(valid))-quantile(Stddev_450nW2(valid),0.05),quantile(Stddev_450nW2(valid),0.95)-median(Stddev_450nW2(valid)));
% axis square; axis([-2 10 0 5]); grid on; title('50nW'); ylabel('Absolute median response'); xlabel('Std dev response');
errorbar(median(Stddev_450nW1(valid)),median(abs(Median_450nW1(valid))), median(abs(Median_450nW1(valid)))-quantile(abs(Median_450nW1(valid)),0.05),quantile(abs(Median_450nW1(valid)),0.95)-median(abs(Median_450nW1(valid))),...
                                                                       median(Stddev_450nW1(valid))-quantile(Stddev_450nW1(valid),0.05),quantile(Stddev_450nW1(valid),0.95)-median(Stddev_450nW1(valid)));
